...
Looking at the in-sample confusion plot gives us an insight as to how accurate the model performs on the training data, the data from 2021-2023. The squares in the upper left and lower right corners of the plot represent cases where the model *correctly* predicted the outcome of the game. The smaller rectangles in the upper right and lower left corners represent cases where the model *incorrectly* predicted the outcome of the game.
...
Our model has an in-sample accuracy of 79.2%, meaning that it correctly predicted the outcome of a game used to train it 79.2% of the time.
...
## Kynan can u write this
## also maybe we could rearrange this and have all the stuff about q1 before all the stuff about q2, lemme know what u think and it'll be an easy move (we should probably delete the headers we have now and make them more blog-posty anyways)
